...
def predictLeaf():
  ...
  return render_template('index.html',uploaded_img="UPLOADED IMAGE:",one=1,insertimage=os.path.join('./static/userimageupload', filename),predicted_as="PREDICTED AS",predict_ans=ans,solution_text="SOLUTION:",solution=sol)
